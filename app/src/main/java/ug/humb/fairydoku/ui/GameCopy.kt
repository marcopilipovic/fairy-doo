...
import ug.humb.fairydoku.game.GameOverReason
...
object GameCopy {
     ...
     * Spielhilfe zu erhalten (siehe [ug.humb.fairydoku.ads.RewardedAdManager]).
     *
     ...
     * Beides existiert — in [ug.humb.fairydoku.ads.RewardedAdManager] und im
     * [ug.humb.fairydoku.ui.components.SettingsOverlay]. Wer eines davon
    ...
    fun legalBody(page: LegalPage): String = when (page) {
        LegalPage.Impressum -> """
            ...
            Alle Bilder der App sind eigene Werke. Die meisten Klänge werden im Spiel selbst berechnet. Die Waldmusik, der Schreckenslaut, die sechs Kicherlaute der Feen sowie die Klänge im Spielverlauf sind mit einem KI-Werkzeug erzeugt und unter dem dort erworbenen Tarif lizenziert.
        """.trimIndent()
