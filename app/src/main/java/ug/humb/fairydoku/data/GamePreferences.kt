...
import ug.humb.fairydoku.game.DailyReward
import ug.humb.fairydoku.game.DailyScore
import ug.humb.fairydoku.game.DailyScoring
import ug.humb.fairydoku.game.DailySettlement
...
class GamePreferencesRepository(context: Context) {
    ...
    private fun currentCycleId(): Long {
        val now = System.currentTimeMillis()
        return ug.humb.fairydoku.game.DailyCycle.cycleIdAt(now, zoneOffsetAt(now))
    }
