...
Wortgleich mit dem, was in der App steht. Quelle ist der
App-Quelltext (`GameCopy.legalBody`); dieser Text entsteht daraus
automatisch und darf nicht von Hand geändert werden.
